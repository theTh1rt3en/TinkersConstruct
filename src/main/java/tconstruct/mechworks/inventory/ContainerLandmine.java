...
public class ContainerLandmine extends Container {
    ...
    public boolean canInteractWith(EntityPlayer entityplayer) {
        ...
        if (block != TinkerMechworks.landmine) return false;
    ...
    public ItemStack slotClick(int par1, int par2, int par3, EntityPlayer par4EntityPlayer) {
        ...
        if (par3 == 5) {
            ...
            if ((i1 != 1 || this.field_94536_g != 2) && i1 != this.field_94536_g) {
                ...
                if (slot != null
                        && func_94527_a(slot, inventoryplayer.getItemStack(), true)
            ...
            if ((par3 == 0 || par3 == 1) && (par2 == 0 || par2 == 1)) {
                ...
                if (slot2.canTakeStack(par4EntityPlayer)) {
                    ...
                    boolean flag =
                            itemstack1 == null || slot2.inventory == inventoryplayer && slot2.isItemValid(itemstack1);
                    k1 = -1;
                    ...
                    if (slot2.getHasStack() && flag) {
                        ...
                        if ((slot2.inventory != inventoryplayer || !slot2.isItemValid(itemstack1))
                                && itemstack1 != null) {
                            if (k1 > -1) {
