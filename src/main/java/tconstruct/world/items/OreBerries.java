...
public class OreBerries extends CraftingItem {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        switch (stack.getItemDamage()) {
            case 0 -> list.add(StatCollector.translateToLocal("oreberries1.tooltip"));
            case 1 -> list.add(StatCollector.translateToLocal("oreberries2.tooltip"));
            case 2 -> list.add(StatCollector.translateToLocal("oreberries3.tooltip"));
            case 3 -> list.add(StatCollector.translateToLocal("oreberries4.tooltip"));
            case 4 -> list.add(StatCollector.translateToLocal("oreberries5.tooltip"));
            case 5 -> list.add(StatCollector.translateToLocal("oreberries6.tooltip"));
        }
    }
