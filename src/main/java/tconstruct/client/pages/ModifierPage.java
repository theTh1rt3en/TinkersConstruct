...
public class ModifierPage extends BookPage {
    ...
    public void renderContentLayer(int localWidth, int localHeight, boolean isTranslatable) {
        ...
        if (type.equals("travelgoggles")) toolstack = MantleClientRegistry.getManualIcon("travelgoggles");
    ...
    public void renderBackgroundLayer(int localWidth, int localHeight) {
        ...
        if (icons.length > 3) manual.drawTexturedModalRect(localWidth - 7, localHeight + 32, 0, 80, 182, 78);
        else manual.drawTexturedModalRect(localWidth + 12, localHeight + 32, 0, 0, 154, 78);
    }
}
