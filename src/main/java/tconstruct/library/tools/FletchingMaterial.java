...
public class FletchingMaterial extends CustomMaterial {
    ...
    public FletchingMaterial(int materialID, int value, ItemStack input, ItemStack craftingItem, float accuracy,
            float breakChance, float duribalityModifier, int color) {
    ...
    @Deprecated
    public FletchingMaterial(int materialID, int value, ItemStack input, ItemStack craftingItem, float accuracy,
            float breakChance, float mass) {
        this(materialID, value, input, craftingItem, accuracy, 0.01f, 1f, 0xffffffff);
    }

    public FletchingMaterial(int materialID, int value, String oredict, ItemStack craftingItem, float accuracy,
            float breakChance, float duribalityModifier, int color) {
