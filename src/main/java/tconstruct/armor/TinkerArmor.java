    ...
    */
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        TinkerArmor.helmetWood =
                new ArmorBasic(TinkerArmor.materialWood, 0, "wood").setUnlocalizedName("tconstruct.helmetWood");
        TinkerArmor.chestplateWood =
                new ArmorBasic(TinkerArmor.materialWood, 1, "wood").setUnlocalizedName("tconstruct.chestplateWood");
        TinkerArmor.leggingsWood =
                new ArmorBasic(TinkerArmor.materialWood, 2, "wood").setUnlocalizedName("tconstruct.leggingsWood");
        TinkerArmor.bootsWood =
                new ArmorBasic(TinkerArmor.materialWood, 3, "wood").setUnlocalizedName("tconstruct.bootsWood");
    ...
    private void craftingTableRecipes() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                new ItemStack(TinkerArmor.heartCanister, 1, 0), " # ", "#B#", " # ", '#', "ingotTin", 'B', Items.bone));
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(TinkerArmor.heartCanister, 1, 1), new ItemStack(TinkerArmor.heartCanister, 1, 3));
        GameRegistry.addShapelessRecipe(
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
                travelBoots.getDefaultItem(), "#s#", "#i#", "#s#", '#', leather, 's', string, 'i', "ingotAluminum"));
    ...
    protected static void addRecipesForDryingRack() {
        ...
        DryingRackRecipes.addDryingRecipe(
                new ItemStack(TinkerWorld.strangeFood, 1, 0), 20 * 60 * 5, new ItemStack(TinkerArmor.jerky, 1, 6));
        DryingRackRecipes.addDryingRecipe(
                new ItemStack(TinkerWorld.strangeFood, 1, 1), 20 * 60 * 5, new ItemStack(TinkerArmor.jerky, 1, 7));
    ...
    private void registerModifiers() {
        ...
        ModifyBuilder.registerModifier(
                new TravelModDoubleJump(EnumSet.of(ArmorPart.Legs, ArmorPart.Feet), new ItemStack[] {
        ...
        ModifyBuilder.registerModifier(new AModInteger(
                4,
                "Moss",
        ...
        // Head
        ModifyBuilder.registerModifier(new AModBoolean(
                0,
                "Night Vision",
        ...
        ModifyBuilder.registerModifier(new AModInteger(
                ...
                new ItemStack[] {
                    new ItemStack(Items.ender_eye), new ItemStack(Items.ender_pearl), new ItemStack(Items.sugar)
                },
                1,
                "\u00a7d",
                "Perfect Dodge"));
        ...
        ModifyBuilder.registerModifier(new AModInteger(
                ...
                "Slimy Soles",
                EnumSet.of(ArmorPart.Feet),
                new ItemStack[] {new ItemStack(TinkerWorld.slimePad, 1, 0), new ItemStack(TinkerWorld.slimePad, 1, 0)},
                1,
                "\u00a7a",
                "Slimy Soles"));
