...
public class ArrowEntity extends EntityArrow implements IEntityAdditionalSpawnData {
                                    ...
                                    movingobjectposition.entityHit.addVelocity(
                                            this.motionX
                                                    ...
                                                    * 0.6000000238418579D
                                                    / (double) f3,
                                            0.1D,
                                            this.motionZ * (double) knockback * 0.6000000238418579D / (double) f3);
                                }
                            }
    ...
    private int storePartialItemStack(ItemStack par1ItemStack, EntityLivingBase living) {
        ...
        if (!par1ItemStack.isStackable()) {
            ...
            if (slotID < 0) {
                ...
                if (living instanceof EntityLiving) ((EntityLiving) living).setEquipmentDropChance(slotID, 2.0f);
    ...
    public void writeSpawnData(ByteBuf data) {
        if (!returnStack.hasTagCompound()) this.kill();
