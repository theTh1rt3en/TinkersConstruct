...
public class TinkerSmeltery {
    ...
    private void addRecipesForTableCasting() {
        ...
        tableCasting.addCastingRecipe(
                ...
                new FluidStack(TinkerSmeltery.moltenAlubrassFluid, Constants.LIQUID_VALUE_INGOT),
                80);
        tableCasting.addCastingRecipe(
                gemcast,
                new FluidStack(TinkerSmeltery.moltenAlubrassFluid, Constants.LIQUID_VALUE_INGOT),
    ...
    protected static void addRecipesForSmeltery() {
        ...
        Smeltery.addMelting(
                ...
                -50,
                Constants.LIQUID_VALUE_INGOT);
        Smeltery.addMelting(gold, new ItemStack(TinkerTools.blankPattern, 4, 2), -50, Constants.LIQUID_VALUE_INGOT * 2);
        Smeltery.addMelting(
    ...
    private void registerIngotCasting(FluidType ft, String name) {
        ...
        for (ItemStack ore : OreDictionary.getOres(name)) {
            ...
            tableCasting.addCastingRecipe(
                    new ItemStack(ore.getItem(), 1, ore.getItemDamage()),
                    new FluidStack(ft.fluid, Constants.LIQUID_VALUE_INGOT),
                    pattern,
                    80);
        }
    }
    ...
    private void registerNuggetCasting(FluidType ft, String name) {
        ...
        for (ItemStack ore : OreDictionary.getOres(name)) {
            ...
            tableCasting.addCastingRecipe(
                    new ItemStack(ore.getItem(), 1, ore.getItemDamage()),
                    new FluidStack(ft.fluid, Constants.LIQUID_VALUE_NUGGET),
                    pattern,
                    40);
        }
    }
