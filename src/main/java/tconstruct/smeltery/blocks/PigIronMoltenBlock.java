...
public class PigIronMoltenBlock extends TConstructFluid {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        if (this.overwriteFluidIcons) this.getFluid().setIcons(stillIcon, flowIcon);
    }

    @Override
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
        if (!world.isRemote && entity != null && !entity.isWet()) entity.setFire(40);
        if (!entity.isWet() || world.rand.nextInt(100) > 73) world.playSoundAtEntity(
                entity,
                "random.fizz",
                0.7F,
